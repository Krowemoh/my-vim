...
syn keyword basicStatement	DATA DEACTIVATEKEY DEBUG DEFFUN DELETE DELETELIST DELETEU DIM DIMENSION DISABLEDEC DISPLAY
syn keyword basicStatement	EQU ECHO ELSE ENABLEDEC END ENTER EOF EQUATE ERRMSG ERROR EXECUTE EXIT
...
syn match  basicStatement	"\$\%(CHAIN\|COPYRIGHT\|DEFINE\|EJECT\|IFDEF\|ENDIF\|IFNDEF\|INCLUDE\|INSERT\|MAP\|OPTIONS\|PAGE\|UNDEFINE\)"
